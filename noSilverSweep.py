                    ...
                    for seed in seeds:
                        for mineral in minerals:
                            cmd = [
                                ...
                                "--logName", f"noSilver_SWEEP1_lr{lr}_bs{batch_size}_mt{model_type}_loss1:{loss_scheme['first_loss']}_two_step{loss_scheme['two_step']}_tn{tn}_seed{seed}_mineral{mineral}_epochs{epochs}", 
                                "--set_seed", str(seed),
